...
- `404` → aucun équipage sélectionnable : **afficher le message renvoyé** et proposer un bouton
  **« Réessayer »** qui relance `GET /api/crew/mine`. Depuis le 2026-09-13, le message est
