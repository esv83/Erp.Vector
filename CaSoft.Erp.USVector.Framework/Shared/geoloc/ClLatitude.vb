Public Class ClLatitude
    Inherits ClGeoPointBase

    Public Sub New(dblLatitude As Double)
        SetValue(dblLatitude)
    ...
    Private Function IsValidValue(dblLatitude As Double) As Boolean
        Dim result As Boolean
        If dblLatitude > -180 And dblLatitude < 180 Then
            result = True
        End If
